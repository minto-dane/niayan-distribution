...
sudo dpkg -i dependencies/*.deb niaos-pkgcore_*_amd64.deb niaos-root-preparation_0.10.0_amd64.deb > install.log 2>&1
sudo python3 check_supply_initialize.py --report /home/builder/niayan-monitor/result.json
