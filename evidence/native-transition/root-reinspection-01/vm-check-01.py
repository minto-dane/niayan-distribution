...
work=Path('/evidence');vmwork=work/'vm-reinspection-01';vmwork.mkdir(exist_ok=False)
...
sudo python3 native/worker/check_root_extract.py --worker /tmp/nia-root-extract/worker --target-base /run/nia-root-extract-test --report /tmp/nia-root-extract/extraction.json
sudo python3 native/worker/check_root_bank.py --worker /tmp/nia-root-extract/worker --base /run/nia-root-extract-test --report /tmp/nia-root-extract/bank.json
sudo python3 native/worker/check_root_reinspection.py --worker /tmp/nia-root-extract/worker --base /run/nia-root-extract-test --report /tmp/nia-root-extract/result.json
...
'''
  ...
  for name in ['extraction.json','bank.json']:
