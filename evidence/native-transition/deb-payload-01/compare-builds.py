...
base=Path('/home/nia/devbox/niaos/.work/native-payload-01'); root=Path('/home/nia/devbox/niaos/nia-os-consent')
...
a=binaries(first);b=binaries(second);assert len(a)==24 and a==b
...
print('24 identical executables; 24 ELF hardening checks;',len(inputs),'inputs match every copy')
