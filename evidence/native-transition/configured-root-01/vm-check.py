...
work=Path('/evidence');vmwork=work/'vm-configured-01';vmwork.mkdir(exist_ok=False)
...
truncate -s 32M /tmp/nia-root-extract/disposable.ext4
...
uname -a
sudo python3 check_configured_root.py --inputs /tmp/nia-root-extract/inputs --worker /tmp/nia-root-extract/worker --target-base /run/nia-root-extract-test --report /tmp/nia-root-extract/result.json
