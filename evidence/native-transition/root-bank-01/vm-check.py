...
work=Path('/evidence');vmwork=work/'vm-bank-03';vmwork.mkdir(exist_ok=False)
...
sudo python3 check_root_extract.py --worker /tmp/nia-root-extract/worker --target-base /var/lib/nia-root-bank-test --report /tmp/nia-root-extract/extraction.json
sudo python3 check_root_bank.py --worker /tmp/nia-root-extract/worker --base /var/lib/nia-root-bank-test --report /tmp/nia-root-extract/result.json
