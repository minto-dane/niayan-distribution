...
procedure Run_Generation_Publication_Tests with SPARK_Mode => Off is
   ...
   Root_Laboratory : constant Boolean := Ada.Command_Line.Argument_Count = 6
      and then Ada.Command_Line.Argument (6) in "root-archive" | "configured-root";
   Configured_Laboratory : constant Boolean := Ada.Command_Line.Argument_Count = 6
      and then Ada.Command_Line.Argument (6) = "configured-root";
...
begin
   ...
   if Laboratory then
      Expect (Site_Laboratory or else (Ada.Command_Line.Argument_Count = 6
         and then Ada.Command_Line.Argument (6) in "checkpoint" | "root-archive" | "configured-root"),
