...
gprbuild -f -P tests.gpr -j1 run_conffile_choice_tests.adb run_root_configuration_tests.adb
build/test-bin/run_conffile_choice_tests /evidence/choice-01/store /evidence/choice-01/root /workspace/pkgcore/tests/fixtures/conffiles > /evidence/choice-test-01.log 2>&1
cat /evidence/choice-test-01.log
...
python3 -B tests/check_configured_root_record.py --native /evidence/root-test-01.log --cas /evidence/root-01/store --driver /workspace/pkgcore/build/test-bin/run_root_configuration_tests --output /evidence/record-oracle-01
