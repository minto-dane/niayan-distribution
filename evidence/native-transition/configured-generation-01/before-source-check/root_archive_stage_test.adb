...
package body Root_Archive_Stage_Test with SPARK_Mode => Off is
   ...
   procedure Run (Store : in out MC_Store.Store; Store_Path : String;
      ...
      Deny_Source, Deny_Inputs, Missing_FD : Boolean := False;
      ...
      begin
         ...
         if not Missing_FD then Root_FD := Source_FD; end if; Status := OK;
      end Observe;
   ...
   begin
      ...
      if Configured then Expect (Input_Calls = 3, "both actual engine reservations reobserve configuration"); end if;
