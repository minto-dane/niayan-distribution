...
base=Path('/home/nia/devbox/niaos/.work/native-final-set-01'); root=Path('/home/nia/devbox/niaos/nia-os-consent')
...
a=binaries(first);b=binaries(second);assert len(a)==27 and a==b
...
print('27 identical executables; 27 ELF hardening checks;',len(inputs),'inputs match every copy')
