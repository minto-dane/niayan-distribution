...
base=Path('/home/nia/devbox/niaos/.work/current-transition-qualification-02'); root=Path('/home/nia/devbox/niaos/nia-os-consent')
...
(base/'reproducibility.json').write_text(json.dumps(dict(result='identical-binaries',binary_count=len(a),first_path='/workspace/pkgcore',second_path='/independent-long-workspace/pkgcore',first_mtimes='preserved checkout mtimes',second_mtime=1788652800,timezones=['UTC system default; TZ unset','Pacific/Honolulu'],source_date_epoch=[None,1788739200],binaries=a),indent=2)+'\n')
rows=[]
...
for tree in [root/'pkgcore',first,second,Path('/home/nia/devbox/niaos/.work/native-generation-transition-01/sanitized')]:
