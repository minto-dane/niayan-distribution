...
sudo python3 check_root_supervisor.py --disposable-vm --library /home/builder/niayan-monitor/root-handoff.so --report /home/builder/niayan-monitor/result.json
