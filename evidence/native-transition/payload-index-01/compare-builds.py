...
base=Path('/home/nia/devbox/niaos/.work/native-payload-index-01'); root=Path('/home/nia/devbox/niaos/nia-os-consent')
...
a=binaries(first);b=binaries(second);assert len(a)==25 and a==b
...
print('25 identical executables; 25 ELF hardening checks;',len(inputs),'inputs match every copy')
