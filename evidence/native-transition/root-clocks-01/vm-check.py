...
work=Path('/evidence');vmwork=work/'vm-stream-02';vmwork.mkdir(exist_ok=False)
...
uname -a
sudo python3 check_root_extract.py --worker /tmp/nia-root-extract/worker --target-base /run/nia-root-extract-test --report /tmp/nia-root-extract/result.json
