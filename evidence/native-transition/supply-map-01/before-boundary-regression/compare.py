...
(work/'reproducibility.json').write_text(json.dumps({'result':'identical-binaries','pkgcore_binary_count':31,
...
print('PASS 31 pkgcore executables and 18 applications identical; 31 ELF checks; exact source copies; seven unchanged mathematical input sets')
