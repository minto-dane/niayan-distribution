...
good(fn('archive_write_set_options',integer,[ptr,text])(writer,b'pax:hdrcharset=BINARY,pax:xattrheader=SCHILY'))
...
raw=buffer.raw[:used.value];Path('/evidence/writer-probe.tar').write_bytes(raw)
