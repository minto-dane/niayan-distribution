...
base=Path('/home/nia/devbox/niaos/.work/native-catalog-01'); root=Path('/home/nia/devbox/niaos/nia-os-consent')
...
a=binaries(first);b=binaries(second);assert len(a)==26 and a==b
...
print('26 identical executables; 26 ELF hardening checks;',len(inputs),'inputs match every copy')
